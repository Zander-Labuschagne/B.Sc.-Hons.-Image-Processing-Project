...
%    cprintf('Blue', '    Niblack binarization completed.\n');
     ...
     %% ------------------------Sauvola-----------------------%%
        ...
        path = 'prep/sauvola/12/';
        
%         prep_wiener9_bin_sauvola_13 = sauvola(prep_wiener_9, 13);
%         imwrite(prep_wiener9_bin_sauvola_13, strcat(path, 'prep_wiener9_bin_sauvola_13.png'));
        prep_median_bin_sauvola_13 = sauvola(prep_median, 13);
        imwrite(prep_median_bin_sauvola_13, strcat(path, 'prep_median_bin_sauvola_13.png'));
        
        bin_sauvola = sauvola(image_gray, 13);
...
%          %imwrite(uint8(bin_gatos), 'bin/gatos/0.065/11/2.bin_gatos.png');
%            T = imread('bin/gatos/0.065/11/1.bin_gatos.png');
%            figure();
%            imagesc(T)
%            colormap('gray');
%             T = imresize(T, 2);
...
%      bin_sauvola_post_wiener_3 = wiener2(bin_sauvola, [3 3]);
%      bin_sauvola_post_wiener_5 = wiener2(bin_sauvola, [5 5]);
%      bin_sauvola_post_wiener_7 = wiener2(bin_sauvola, [7 7]);
%      bin_sauvola_post_wiener_9 = wiener2(bin_sauvola, [9 9]);
%      bin_sauvola_post_wiener_11 = wiener2(bin_sauvola, [11 11]);
%      bin_sauvola_post_wiener_13 = wiener2(bin_sauvola, [13 13]);
%      bin_sauvola_post_wiener_15 = wiener2(bin_sauvola, [15 15]);
%      
%      path = 'post/sauvola/wiener/2/';
%      imwrite(bin_sauvola_post_wiener_3, strcat(path, 'bin_sauvola_post_wiener_3.png'));
%      imwrite(bin_sauvola_post_wiener_5, strcat(path, 'bin_sauvola_post_wiener_5.png'));
%      imwrite(bin_sauvola_post_wiener_7, strcat(path, 'bin_sauvola_post_wiener_7.png'));
%      imwrite(bin_sauvola_post_wiener_9, strcat(path, 'bin_sauvola_post_wiener_9.png'));
%      imwrite(bin_sauvola_post_wiener_11, strcat(path, 'bin_sauvola_post_wiener_11.png'));
%      imwrite(bin_sauvola_post_wiener_13, strcat(path, 'bin_sauvola_post_wiener_13.png'));
%      imwrite(bin_sauvola_post_wiener_15, strcat(path, 'bin_sauvola_post_wiener_15.png'));

     %% ----------------------Median Low Pass Filter-------------------- %%
        cprintf('Black', '    Median Low Pass Filter started...\n');
        bin_sauvola_post_median = medfilt2(bin_sauvola);
        imwrite(bin_sauvola_post_median, 'post/sauvola/median/12.bin_otsu_post_median.png');
        cprintf('Blue', '    Median Low Pass Filter completed.\n');
